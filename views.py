...
from services import UserService, FavoriteService, CustomerService, LicenceService #AssetService

user_router = APIRouter(prefix='/user')
assets_router = APIRouter(prefix='/assets')
customer_router = APIRouter(prefix='/customer')
licence_router = APIRouter(prefix='/licence')

@user_router.post('/create', description='This view create a new customer', response_model=StandardOutput, responses={400: {'model': ErrorOutput}})
